...
; ==================================================================
	...
	%DEFINE MASTEROS2_VER '4.6.1'	; OS version number
	%DEFINE MASTEROS2_API_VER 17	; API version for programs to check
...
option_screen:
	...
	os_init_msg		db 'Welcome to MasterOS 2.0!', 0
	os_version_msg		db 'Version ', MASTEROS2_VER, 0

	dialog_string_1		db 'Thanks for trying out MasterOS 2.0!', 0
